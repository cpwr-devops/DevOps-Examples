...
<table>
    ...
    <tr>
        ...
        <td><a href="">As parameter in the config file <code class="highlighter-rouge">tttgit.config</code></a></td>
        <td>Git/GitHub</td>
    ...
    <tr>
        ...
        <td><a href="">As parameter in the config file <code class="highlighter-rouge">pipeline.config</code></a></td>
    ...
    <tr>
        ...
        <td>
            <ul>
                ...
                <li><a href="../tool_configuration/webhook_setup.html#URL">Via the ISPW Webhook as value 2: The pipeline expects a set container.</a></li>
            </ul>
        </td>
        <td>N/A</td>
        <td>N/A</td>
    ...
    <tr>
        ...
        <td>In the list at <code class="highlighter-rouge">Manage Jenkins</code> --&gt; <code class="highlighter-rouge">Credentials</code> in column <code class="highlighter-rouge">ID</code></td>
    </tr>
    <tr>
